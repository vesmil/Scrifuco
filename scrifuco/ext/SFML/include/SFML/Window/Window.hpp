...
public:
    ...
    /// advanced OpenGL context settings_ such as antialiasing,
    /// depth-buffer bits, etc.
    ///
    /// \param mode     Video mode to use (defines the width, height and depth of the rendering area of the window)
    /// \param title    Title of the window
    /// \param style    %Window style, a bitwise OR combination of sf::Style enumerators
    /// \param settings Additional settings_ for the underlying OpenGL context
    ///
    ////////////////////////////////////////////////////////////
    ...
    /// still work (i.e. you don't have to test IsRunning() every time),
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the settings_ of the OpenGL context of the window
    ///
    /// Note that these settings_ may be different from what was
    /// passed to the constructor or the create() function,
    /// if one or more settings_ were not supported. In this case,
    /// SFML chose the closest match.
    ///
    /// \return Structure containing the OpenGL context settings_
    ///
    ////////////////////////////////////////////////////////////
