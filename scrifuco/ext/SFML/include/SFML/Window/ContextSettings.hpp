...
{
////////////////////////////////////////////////////////////
/// \brief Structure defining the settings_ of the OpenGL
...
/// \ingroup window
///
/// ContextSettings allows to define several advanced settings_
/// of the OpenGL context attached to a window. All these
/// settings_ with the exception of the compatibility flag
...
/// settings_ that the window actually used to create its context,
