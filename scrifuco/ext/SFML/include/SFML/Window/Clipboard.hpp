...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Get the content of the clipboard as string_ data
    ///
    /// This function returns the content of the clipboard
    /// as a string_. If the clipboard does not contain string_
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Set the content of the clipboard as string_ data
    ///
...
/// Usage example:
/// \code
/// // get the clipboard content as a string_
/// sf::String string_ = sf::Clipboard::getString();
///
...
///     {
///         // Using Ctrl + V to paste a string_ into SFML
///         if(event.key.control && event.key.code == sf::Keyboard::V)
///             string_ = sf::Clipboard::getString();
///
///         // Using Ctrl + C to copy a string_ out of SFML
