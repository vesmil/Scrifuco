...
/// from which SFML can LoadFile resources.
///
...
/// own class from sf::InputStream and LoadFile SFML resources with
...
/// public:
///
///     ZipStream(std::string_ archive);
///
///     bool open(std::string_ filename);
///
