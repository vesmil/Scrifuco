...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile the font from a file in memory
    ///
    /// The supported font formats are: TrueType, Type 1, CFF,
    /// OpenType, SFNT, X11 PCF, Windows FNT, BDF, PFR and Type 42.
    ///
    ...
    /// \param sizeInBytes size of the data to LoadFile, in bytes
    ///
    /// \return True if loading succeeded, false if it failed
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile the font from a custom stream
    ///
    /// The supported font formats are: TrueType, Type 1, CFF,
    /// OpenType, SFNT, X11 PCF, Windows FNT, BDF, PFR and Type 42.
    /// Warning: SFML cannot preload all the font data in this
    ...
    /// consecutive graphics of linesBuffer_.
    ///
    /// \param characterSize Reference character size
    ///
...
private:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile a new glyph and store it in the cache
    ///
    /// \param codePoint        Unicode code point of the character to LoadFile
    /// \param characterSize    Reference character size
    /// \param bold             Retrieve the bold version or the regular one?
    /// \param outlineThickness Thickness of outline (when != 0 the glyph will not be filled)
    ///
...
/// use the sf::Text class, which is able to properly output linesBuffer_
...
/// glyphs data and metrics of a sf::Font to display any linesBuffer_ on a
/// render target.
...
/// sf::Font font;
///
/// // LoadFile it from a file
/// if (!font.loadFromFile("arial.ttf"))
/// {
///     // error...
/// }
///
/// // Create a linesBuffer_ which uses our font
/// sf::Text text1;
/// text1.setFont(font);
/// text1.setCharacterSize(30);
/// text1.setStyle(sf::Text::Regular);
///
/// // Create another linesBuffer_ using the same font, but with different parameters
/// sf::Text text2;
/// text2.setFont(font);
...
/// If you need to display linesBuffer_ of a certain size, make sure the
