...
/// Example:
/// \code
/// sf::VertexArray graphics(sf::LineStrip, 4);
/// graphics[0].position = sf::Vector2f(10, 0);
/// graphics[1].position = sf::Vector2f(20, 0);
/// graphics[2].position = sf::Vector2f(30, 5);
/// graphics[3].position = sf::Vector2f(40, 2);
///
