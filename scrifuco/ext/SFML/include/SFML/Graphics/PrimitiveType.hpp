...
///
/// points and graphics have no area, therefore their thickness
...
enum PrimitiveType
{
    ...
    Lines,         ///< List of individual graphics
    LineStrip,     ///< List of connected graphics, a point uses the previous point to form a line
