...
public:
    ...
    ///
    /// \see setUniform(const std::string_&, CurrentTextureType)
    ///
    ////////////////////////////////////////////////////////////
...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile the vertex, geometry or fragment shader from a file
    ///
    /// This function loads a single shader, vertex, geometry or
    /// fragment, identified by the second argument.
    /// The source must be a linesBuffer_ file containing a valid
    /// shader in GLSL language. GLSL is a C-like language
    /// dedicated to OpenGL shaders; you'll probably need to
    /// read a good documentation for it before writing your
    /// own shaders.
    ///
    /// \param filename Path of the vertex, geometry or fragment shader file to LoadFile
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile both the vertex and fragment shaders from files
    ///
    /// This function loads both the vertex and the fragment
    /// shaders. If one of them fails to LoadFile, the shader is left
    /// empty (the valid shader is unloaded).
    /// The sources must be linesBuffer_ files containing valid shaders
    /// in GLSL language. GLSL is a C-like language dedicated to
    /// OpenGL shaders; you'll probably need to read a good documentation
    /// for it before writing your own shaders.
    ///
    /// \param vertexShaderFilename   Path of the vertex shader file to LoadFile
    /// \param fragmentShaderFilename Path of the fragment shader file to LoadFile
    ///
    /// \return True if loading succeeded, false if it failed
    ///
    /// \see loadFromMemory, loadFromStream
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile the vertex, geometry and fragment shaders from files
    ///
    ...
    ///
    /// \param vertexShaderFilename   Path of the vertex shader file to LoadFile
    /// \param geometryShaderFilename Path of the geometry shader file to LoadFile
    /// \param fragmentShaderFilename Path of the fragment shader file to LoadFile
    ///
    /// \return True if loading succeeded, false if it failed
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile the vertex, geometry or fragment shader from a source code in memory
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile both the vertex and fragment shaders from source codes in memory
    ///
    /// This function loads both the vertex and the fragment
    /// shaders. If one of them fails to LoadFile, the shader is left
    /// empty (the valid shader is unloaded).
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile the vertex, geometry and fragment shaders from source codes in memory
    ///
    /// This function loads the vertex, geometry and fragment
    /// shaders. If one of them fails to LoadFile, the shader is left
    /// empty (the valid shader is unloaded).
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile the vertex, geometry or fragment shader from a custom stream
    ///
    /// This function loads a single shader, vertex, geometry
    /// or fragment, identified by the second argument.
    /// The source code must be a valid shader in GLSL language.
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile both the vertex and fragment shaders from custom streams
    ///
    /// This function loads both the vertex and the fragment
    /// shaders. If one of them fails to LoadFile, the shader is left
    /// empty (the valid shader is unloaded).
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile the vertex, geometry and fragment shaders from custom streams
    ///
    /// This function loads the vertex, geometry and fragment
    /// shaders. If one of them fails to LoadFile, the shader is left
    /// empty (the valid shader is unloaded).
    ...
    ///
    /// \deprecated Use setUniform(const std::string_&, float) instead.
    ///
    ////////////////////////////////////////////////////////////
    ...
    ///
    /// \deprecated Use setUniform(const std::string_&, const Glsl::Vec2&) instead.
    ///
    ////////////////////////////////////////////////////////////
    ...
    ///
    /// \deprecated Use setUniform(const std::string_&, const Glsl::Vec3&) instead.
    ///
    ////////////////////////////////////////////////////////////
    ...
    ///
    /// \deprecated Use setUniform(const std::string_&, const Glsl::Vec4&) instead.
    ///
    ////////////////////////////////////////////////////////////
    ...
    ///
    /// \deprecated Use setUniform(const std::string_&, const Glsl::Mat4&) instead.
    ///
    ////////////////////////////////////////////////////////////
    ...
    ///
    /// \deprecated Use setUniform(const std::string_&, const Texture&) instead.
    ///
    ////////////////////////////////////////////////////////////
    ...
    /// \brief Change a texture parameter of the shader
    ///
    /// \deprecated Use setUniform(const std::string_&, CurrentTextureType) instead.
    ///
    ////////////////////////////////////////////////////////////
...
/// of the linesBuffer_ is not the actual linesBuffer_ that you see on screen, it is
