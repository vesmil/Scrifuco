...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile the texture from a file on disk
    ///
    ...
    /// \endcode
    ///
    /// The \a area argument can be used to LoadFile only a sub-rectangle
    ...
    /// If this function fails, the texture is left unchanged.
    ///
    /// \param filename Path of the image file to LoadFile
    /// \param area     Area of the image to LoadFile
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile the texture from a file in memory
    ///
    /// This function is a shortcut for the following code:
    /// \code
    /// sf::Image image;
    ...
    /// \param size size of the data to LoadFile, in bytes
    /// \param area Area of the image to LoadFile
    ///
    /// \return True if loading was successful
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile the texture from a custom stream
    ///
    /// This function is a shortcut for the following code:
    /// \code
    /// sf::Image image;
    ...
    ////////////////////////////////////////////////////////////
    /// \brief LoadFile the texture from an image
    ///
    /// The \a area argument can be used to LoadFile only a sub-rectangle
    /// of the whole image. If you want the entire image then leave
    /// the default value (which is an empty IntRect).
    ...
    /// If this function fails, the texture is left unchanged.
    ///
    /// \param image Image to LoadFile into the texture
    /// \param area  Area of the image to LoadFile
    ///
    /// \return True if loading was successful
    ///
...
/// before creating the final texture, you can LoadFile your file to a
...
/// // drawing a sprite
///
/// // LoadFile a texture from a file
/// sf::Texture texture;
